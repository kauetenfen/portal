...
import br.com.coontrol.portal.view.dto.Pessoa;
import br.com.coontrol.portal.view.util.RestResponsePage;

@Service
public class PessoaServiceView {
	
	private static final String URL_SERVICE_PESSOAS = "http://localhost:8080/portal/private/pessoas";

	public List<Pessoa> obterListaPessoas() {
		 RestTemplate restTemplate = new RestTemplate();
		 restTemplate.getInterceptors().add(new BasicAuthenticationInterceptor("coontrol","12345"));
